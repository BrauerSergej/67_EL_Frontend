...
- label: "Price", опции: "Опции прыидумайте сами, главное, чтобы было несколько опций и какждая опция имела дианпозон цен. Например: 0-200$"
- label: "Choose product", опции: "Jeans", "T-shirt", "Jacket", "Sweater"
7. (Опционально, т.к задание со \*)Справа от селектов, должна находиться кнопка "Search", при клике на которую, товары дожны отфильтроваться и появиться только те карточки, котрые соответствуют выбранным опциям в ваших фильтрах
8. Приложение должно быть на английском языке
9. Стили на ваше усмотрение
10. Если вы выполнили задание со звездочкой(там где нужно сделать фильтры): Внизу справа экрана должна быть стрелочка "вверх" с текстом "Back to filters", по клику на которую, вас переносит к фильтрам. Этот элемент дожен быть с фиксированной позицией. Если вы не выполнили задание со звездочкой: Внизу справа экрана должна быть стрелочка "вверх" с текстом "Go Up", по клику на которую, вас переносит к самой верхней части экрана. Этот элемент дожен быть с фиксированной позицией